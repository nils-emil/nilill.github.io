...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppEmailPageEmailPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EmailPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 4,
      consts: [[1, "header-container"], [1, "header-logo", 3, "click"], [1, "header-container", "mt-0"], [2, "padding-top", "10rem"], [1, "flex-row-container", "mt-0"], [1, "col-12", "flex-center"], ["src", "../../assets/two-guys-building-robocop.svg", "alt", "Kiwi standing on oval", 1, "col-12"], [1, "flex-row-container", "pb-10", "mt-0"], [1, "col-12"], [2, "text-align", "center"], ["style", "text-align: center", 4, "ngIf"], ["style", "text-align: center", "class", "success-message", 4, "ngIf"], [3, "ngSubmit"], ["class", "flex-center", "style", "margin-bottom: 3rem", 4, "ngIf"], [1, "col-12", "relative", "flex-center"], ["type", "submit", "class", "btn", "style", "padding-left: 4rem; padding-right: 4rem", 4, "ngIf"], [1, "success-message", 2, "text-align", "center"], [1, "flex-center", 2, "margin-bottom", "3rem"], ["autocomplete", "off", "name", "email", "type", "email", "value", "", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", 2, "padding-left", "4rem", "padding-right", "4rem"]],
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_h1_click_85_listener() {
